...
namespace codebattle_api.Migrations
{
    ...
    [Migration("20230605213958_MejorasFuncionalidadBatallas")]
    partial class MejorasFuncionalidadBatallas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResultStep", b =>
                {
                    ...
                    b.HasKey("ResultsId", "StepsId");

                    b.HasIndex("StepsId");

                    b.ToTable("ResultStep");
                });
            ...
            modelBuilder.Entity("codebattle_api.Entities.Result", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ResultStep", b =>
                {
                    b.HasOne("codebattle_api.Entities.Result", null)
                        .WithMany()
