...
import { faCrown, faCircleArrowUp, faUser, faRightFromBracket, faFlag,
    ...
    faXmark, faXmarkCircle, faCircleXmark, faCircleExclamation, faTriangleExclamation, faCircleInfo, faCircleCheck, faFileImport } from '@fortawesome/free-solid-svg-icons';
...
library.add(faCrown, faCircleArrowUp, faUser, faRightFromBracket, 
    ...
    faBrain, faStopwatch, faCircleXmark, faXmark, faCircleExclamation, faTriangleExclamation, faCircleInfo, faCircleCheck, faFileImport)
